"""
Django settings for daymar_tailor_shop_backend project.
...
ROOT_URLCONF = 'daymar_tailor_shop_backend.urls'
...
WSGI_APPLICATION = 'daymar_tailor_shop_backend.wsgi.application'
